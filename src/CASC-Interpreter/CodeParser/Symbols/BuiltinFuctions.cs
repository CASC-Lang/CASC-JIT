...
namespace CASC.CodeParser.Symbols
{
    internal static class BuiltinFunctions
    {
        ...
        public static readonly FunctionSymbol Print = new FunctionSymbol("print", ImmutableArray.Create(new ParameterSymbol("string", TypeSymbol.String, 0)), TypeSymbol.Void);
